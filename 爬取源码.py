...
api_url = "https://api.bilibili.com/x/web-interface/popular?ps=20&pn=1&web_location=333.934&w_rid=4074d62026172870377cbcdb0ef4fe52&wts=1741944568"
...
print(response.json())  # 这里会包含结构化数据